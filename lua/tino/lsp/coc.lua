...
keyset("x", "<leader>cc", "<Plug>(coc-codeaction-selected)", opts)
keyset("n", "<leader>cc", "<Plug>(coc-codeaction-selected)", opts)
...
-- Show commands
keyset("n", "<space>cmd", ":<C-u>CocList commands<cr>", opts)
-- Find symbol of current document
keyset("n", "<space>co", ":<C-u>CocList outline<cr>", opts)
-- Search workspace symbols
keyset("n", "<space>cmb", ":<C-u>CocList -I symbols<cr>", opts)
